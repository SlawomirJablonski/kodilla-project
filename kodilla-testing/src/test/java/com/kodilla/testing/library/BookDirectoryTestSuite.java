...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOfUserWith5Books() {
        ...
        LibraryUser libraryUser = new LibraryUser("Aaaaa", "Bbbbb","80080808080");

        List<Book> resultListOf5Books = generateListOfNBooks(5);

        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(resultListOf5Books);
        //When
        List<Book> booksInHandsOf = libraryDatabaseMock.listBooksInHandsOf(libraryUser);
        //Then
        assertEquals(5,booksInHandsOf.size());
    }

    @Test
    public void testListBooksInHandsOfUserWith1Books() {
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
